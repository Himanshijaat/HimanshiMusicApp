...
public class FilesUtils extends Activity {
    ...
    public Boolean CreateImageDir() {
        ...
        if (permGranted) {
            ...
            if (isPresent) {
                ...
                File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), "/BhaktiMusic/Images");
                if (mediaStorageDir.exists()) {
                    Log.d("App", "Directory presented");
                    return false;
    ...
    public Boolean checkImageFolder(){
        File folder = new File(Environment.getExternalStorageDirectory() + File.separator + "BhaktiMusic/Images");
