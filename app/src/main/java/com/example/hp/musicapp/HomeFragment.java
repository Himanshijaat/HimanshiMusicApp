...
public class HomeFragment extends Fragment {
    ...
    private void prepareAlbums() {
        ...
        Main_Bean a = new Main_Bean(getString(R.string.home_festival_aartiyan), 14, covers[4],trackID[0]);
        albumList.add(a);
        ...
        a = new Main_Bean(getString(R.string.home_poojan_kriya), 12, covers[3],trackID[0]);
        albumList.add(a);
